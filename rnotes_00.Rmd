...
__Ex.2__ Given any number n print 10 subsequent numbers and finally print the sum.
<br>
...
```
__Ex.3__ Print the Fibonacci sequence upto 10 terms and print the value of the golden ratio.
